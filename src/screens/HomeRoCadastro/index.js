...
export default () => {
  ...
  const [tipoOcorrenciaRo, setTipoOcorrenciaRo] = useState({
    "Retirada de objetos na via": "Retirada de objetos na via",
    "Auxilio Púbico": "Auxilio Púbico",
    "Atendimento a deficiente físico": "Atendimento a deficiente físico",
    "Atendimento a deficiente visual": "Atendimento a deficiente visual",
    "Retirada de objetos na via": "Retirada de objetos na via",
    "Achados e perdidos": "Achados e perdidos",
    "Comportamento indevido": "Comportamento indevido",
    "Atitude Suspeita": "Atitude Suspeita",
    Panfletagem: "Panfletagem",
    "Pedestre na via": "Pedestre na via",
    "Pessoa inconvenientemente trajada": "Pessoa inconvenientemente trajada",
    "Simulação de mal súbito": "Simulação de mal súbito",
    "Recolhimento de billhete": "Recolhimento de billhete",
    "Vendedor ambulante": "Vendedor ambulante",
    "Aliciamento de freguesia": "Aliciamento de freguesia",
    Tumulto: "Tumulto",
    "Remoção de animal": "Remoção de animal",
    Incêndio: "Incêndio",
    "Fogo na vegetação da faixa de domínio":
      "Fogo na vegetação da faixa de domínio",
    "Retirada de objetos da rede aérea": "Retirada de objetos da rede aérea",
    "Evacuação de trem": "Evacuação de trem",
    "Evacuação de Estação": "Evacuação de Estação",
    Outros: "Outros",
    "Pedido de Providências": "Pedido de Providências",
    "Verificação de falhas nas instalaçôes":
      "Verificação de falhas nas instalaçôes",
    Embriaguez: "Embriaguez",
    Mendicância: "Mendicância",
    "Pertubação da tranquilidade": "Pertubação da tranquilidade",
    "Pertubação do trabalho ou sossego alheio":
      "Pertubação do trabalho ou sossego alheio",
    "Arremesso de Prójeteis": "Arremesso de Prójeteis",
    "Encontro de material suspeito": "Encontro de material suspeito",
    "Queixa de crime": "Queixa de crime",
    "Ato Obceno": "Ato Obceno",
    "Importunação ofensiva ao pudor": "Importunação ofensiva ao pudor",
  });

  const [tipoOcorrenciaRau, setTipoOcorrenciaRau] = useState({
    Acidente: "Acidente",
    "Acidente na escada rolante": "Acidente na escada rolante",
    "Acidente na escada fixa": "Acidente na escada fixa",
    "Mal súbito": "Mal súbito",
    "Pessoa com suspeita de doença mental":
      "Pessoa com suspeita de doença mental",
    "Acidente no espaço entre o trem e plataforma":
      "Acidente no espaço entre o trem e plataforma",
    "Acidente na abertura ou fechamento do trem":
      "Acidente na abertura ou fechamento do trem",
    "Atropelamento sem vítima fatal": "Atropelamento sem vítima fatal",
  });

  const [tipoOcorrenciaBo, setTipoOcorrenciaBo] = useState({
    ...
    "Porte ilegal de arma": "Porte ilegal de arma",
    "Disparo de arma de fogo": "Disparo de arma de fogo",
    Rixa: "Rixa",
    "Vias de fato": "Vias de fato",
    Estelionato: "Estelionato",
    "Fraude a tarifa de transporte": "Fraude a tarifa de transporte",
    "Dano ao patrimônio": "Dano ao patrimônio",
    "Tentativa de dano ao patrimônio": "Tentativa de dano ao patrimônio",
    Pixação: "Pixação",
    Furto: "Furto",
    "Tentativa de furto": "Tentativa de furto",
    "Furto de cabos eletricos": "Furto de cabos eletricos",
    Roubo: "Roubo",
    "Tentativa de Roubo": "Tentativa de Roubo",
    "Porte de entorpecente": "Porte de entorpecente",
    "Uso de entorpecente": "Uso de entorpecente",
    "Encontro de cadáver": "Encontro de cadáver",
    "Encontro de feto": "Encontro de feto",
    "Encontro de veículo furtado": "Encontro de veículo furtado",
    "Ameaça de bomba": "Ameaça de bomba",
    "Venda ilegal de bilhetes": "Venda ilegal de bilhetes",
    "Apreensão de cédula falsa": "Apreensão de cédula falsa",
    "Apreensão de moeda falsa": "Apreensão de moeda falsa",
    Calúnia: "Calúnia",
    Injúria: "Injúria",
    Racismo: "Racismo",
    Difamação: "Difamação",
    "Tentativa de furto de cabos elétricos":
      "Tentativa de furto de cabos elétricos",
  });
  const [tipoOcorrenciaRRM, setTipoOcorrenciaRRM] = useState({
    Panfletagem: "Panfletagem",
    "Recolhimento de mercadoria": "Recolhimento de mercadoria",
    "Recolhimento de bilhete": "Recolhimento de bilhete",
  });
  ...
  const [hora, setHora] = useState(
    moment().utcOffset("-03:00").format(" hh:mm:ss a"),
  );
  ...
  const [switchRegistroCoincidente, setSwitchRegistroCoincidente] =
    useState(false);
  ...
  const [switchAgenteParticipante1, setSwitchAgenteParticipante1] =
    useState(false);
  ...
  const [tipoEnvolvimentoAgente1, setTipoEnvolvimentoAgente1] =
    useState("Agente Integrante");

  //Agente participante 2
  const [switchAgenteParticipante2, setSwitchAgenteParticipante2] =
    useState(false);
  ...
  const [tipoEnvolvimentoAgente2, setTipoEnvolvimentoAgente2] =
    useState("Agente Integrante");
  ...
  useEffect(() => {
    ...
    if (
      tipoOcorrencia1 === "Apreensão de cédula falsa" ||
      tipoOcorrencia1 === "Apreensão de moeda falsa"
    ) {
      setNotaFalsa(true);
    } else {
      setNotaFalsa(false);
  ...
  useEffect(() => {
    ...
    switchEnv3,
    switchEnv4,
    switchAgenteParticipante1,
    switchAgenteParticipante2,
    switchMarcaDagua,
    switchMicroImpressoes,
    switchRegistroCoincidente,
    switchImagemLatente,
    switchImpressaoRelevo,
    switchNumeraçaoNota,
    switchFibrasColoridas,
    switchMarcaTatil,
    switchFioDeSegurança,
    switchFundosEspeciais,
    switchFibrasLuzVioleta,
    switchFaixaHoografica,
    switchTipoDoPapel,
    switchJanelaTransparente,
  ]);
    ...
    <Container>
      ...
      <View style={styles.viewFotoMais}>
        <View>
          ...
          >
            <Image
              style={styles.formFoto}
              resizeMode="stretch"
              source={
                foto ? foto : require("../../../assets/adicionarimagem.png")
              }
            />
          </ImageSpace>
        </View>
        ...
        <View style={styles.viewInpustsCima}>
          <Inputs
            source={require("../../../assets/rgicon.png")}
            placeholder="RG"
            placeholderTextColor="#666360"
            keyboardType="number-pad"
            value={identidade}
            onChangeText={(t) => setIdentidade(t)}
          />
          <Inputs
            source={require("../../../assets/rgicon.png")}
            placeholder="CPF"
          ...
          <Inputs
            ...
            keyboardType="number-pad"
            value={telefone}
            onChangeText={(t) => mascaraTelefone(t)}
          />
        </View>
      </View>
      ...
      <View style={styles.viewNascimento}>
        <InputMenor
          ...
          keyboardType="number-pad"
          value={nascimento}
          onChangeText={(t) => mascaraNascimento(t)}
        />
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          ...
          placeholderTextColor="#666360"
          value={nacionalidade}
          onChangeText={(t) => setNacionalidade(t)}
        />
        <InputMenorAinda
          source={require("../../../assets/map-pin.png")}
          ...
          placeholderTextColor="#666360"
          value={naturalidade}
          onChangeText={(t) => setNaturalidade(t)}
        />
      </View>
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          ...
          placeholderTextColor="#666360"
          value={idadeAparente}
          onChangeText={(t) => setIdadeAparente(t)}
        />
        <Picker
          mode="dropdown"
      ...
      <View style={styles.viewCidadeBairro}>
        ...
        <InputMenorAinda
          ...
          placeholderTextColor="#666360"
          value={ocupaçãoAtual}
          onChangeText={(t) => setOcupaçãoAtual(t)}
        />
      </View>
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          ...
          placeholderTextColor="#666360"
          value={orgãoExpedidor}
          onChangeText={(t) => setOrgãoEpedidor(t)}
        />
        <Picker
          mode="dropdown"
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          ...
          placeholderTextColor="#666360"
          value={ufEnvolvido}
          onChangeText={(t) => setUfEnvolvido(t)}
        />
        <Picker
          mode="dropdown"
          ...
          onValueChange={(itemValue, itemIndex) =>
            setTipoDeEnvolvimento(itemValue)
          }
        >
          <Picker.Item
            label="Tipo de Envolvimento"
            value="Tipo de Envolvimento"
          />
      ...
      <View style={styles.viewLogradoro}>
        ...
        <InputMenorAinda
          ...
          placeholderTextColor="#666360"
          value={numeroCasa}
          onChangeText={(t) => setNumeroCasa(t)}
        />
      </View>
      ...
      <View style={styles.viewCidadeBairro}>
        <InputsInteiro
          ...
          placeholderTextColor="#666360"
          value={paisMoradia}
          onChangeText={(t) => setpaisMoradia(t)}
        />
      </View>
      ...
      >
        ...
        <Switch
          thumbColor="#FF9000"
          trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
          value={switchEnv2}
          onValueChange={(t) => setSwitchEnv2(t)}
        />
      </View>
        ...
        <View>
          ...
          <View style={{ marginLeft: 30, marginTop: 15 }}>
            <InputsInteiro
              ...
              placeholderTextColor="#666360"
              keyboardType="number-pad"
              value={identidadeEnv2}
              onChangeText={(t) => setIdentidadeEnv2(t)}
            />
            <InputsInteiro
              source={require("../../../assets/rgicon.png")}
              placeholder="CPF"
              ...
              keyboardType="number-pad"
              value={cpfEnv2}
              onChangeText={(t) => mascaraCpfEnv2(t)}
            />
            <InputsInteiro
              source={require("../../../assets/phone.png")}
              placeholder="Telefone"
              ...
              keyboardType="number-pad"
              value={telefoneEnv2}
              onChangeText={(t) => mascaraTelefoneEnv2(t)}
            />
          </View>
          ...
          <View style={styles.viewNascimento}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              keyboardType="number-pad"
              value={nascimentoEnv2}
              onChangeText={(t) => mascaraNascimentoEnv2(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Nacionalidade"
              placeholderTextColor="#666360"
              value={nacionalidadeEnv2}
              onChangeText={(t) => setNacionalidadeEnv2(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Naturalidade"
              placeholderTextColor="#666360"
              value={naturalidadeEnv2}
              onChangeText={(t) => setNaturalidadeEnv2(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Idade Aparente"
              placeholderTextColor="#666360"
              value={idadeAparenteEnv2}
              onChangeText={(t) => setIdadeAparenteEnv2(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cutisEnv2}
              onChangeText={(t) => setCutisEnv2(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Ocupação Atual"
              placeholderTextColor="#666360"
              value={ocupaçãoAtualEnv2}
              onChangeText={(t) => setOcupaçãoAtualEnv2(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Orgão Expedidor"
              placeholderTextColor="#666360"
              value={orgãoExpedidorEnv2}
              onChangeText={(t) => setOrgãoEpedidorEnv2(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="UF Nascimento"
              placeholderTextColor="#666360"
              value={ufEnvolvidoEnv2}
              onChangeText={(t) => setUfEnvolvidoEnv2(t)}
            />
            ...
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) =>
                setTipoDeEnvolvimentoEnv2(itemValue)
              }
            >
              <Picker.Item
                label="Tipo de Envolvimento"
          ...
          <View style={styles.viewEstado}>
            <InputMenor
              ...
              maxLength={8}
              placeholderTextColor="#666360"
              onEndEditing={() => buscarCepenv2(cepEnv2)}
              keyboardType="number-pad"
              value={cepEnv2}
              onChangeText={(t) => setCepEnv2(t)}
            />
            <Picker
              mode="dropdown"
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cidadeEnv2}
              onChangeText={(t) => setCidadeEnv2(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Bairro"
              placeholderTextColor="#666360"
              value={bairroEnv2}
              onChangeText={(t) => setBairroEnv2(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            <InputMenor
              ...
              placeholder="Logradouro"
              placeholderTextColor="#666360"
              value={logradouroEnv2}
              onChangeText={(t) => setLogradouroEnv2(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Número"
              keyboardType="number-pad"
              placeholderTextColor="#666360"
              value={numeroCasaEnv2}
              onChangeText={(t) => setNumeroCasaEnv2(t)}
            />
          </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <InputsInteiro
              ...
              placeholder="Complemento"
              placeholderTextColor="#666360"
              value={complementoEnv2}
              onChangeText={(t) => setComplementoEnv2(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputsInteiro
              ...
              placeholder="País"
              placeholderTextColor="#666360"
              value={paisMoradiaEnv2}
              onChangeText={(t) => setpaisMoradiaEnv2(t)}
            />
          </View>
          ...
          >
            ...
            <Switch
              ...
              trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
              value={switchEnv3}
              onValueChange={(t) => setSwitchEnv3(t)}
            />
          </View>
        </View>
      )}
        ...
        <View>
          ...
          <View style={{ marginLeft: 30, marginTop: 15 }}>
            <InputsInteiro
              ...
              placeholderTextColor="#666360"
              keyboardType="number-pad"
              value={identidadeEnv3}
              onChangeText={(t) => setIdentidadeEnv3(t)}
            />
            <InputsInteiro
              source={require("../../../assets/rgicon.png")}
              placeholder="CPF"
              ...
              keyboardType="number-pad"
              value={cpfEnv3}
              onChangeText={(t) => mascaraCpfEnv3(t)}
            />
            <InputsInteiro
              source={require("../../../assets/phone.png")}
              placeholder="Telefone"
              ...
              keyboardType="number-pad"
              value={telefoneEnv3}
              onChangeText={(t) => mascaraTelefoneEnv3(t)}
            />
          </View>
          ...
          <View style={styles.viewNascimento}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              keyboardType="number-pad"
              value={nascimentoEnv3}
              onChangeText={(t) => mascaraNascimentoEnv3(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Nacionalidade"
              placeholderTextColor="#666360"
              value={nacionalidadeEnv3}
              onChangeText={(t) => setNacionalidadeEnv3(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Naturalidade"
              placeholderTextColor="#666360"
              value={naturalidadeEnv3}
              onChangeText={(t) => setNaturalidadeEnv3(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Idade Aparente"
              placeholderTextColor="#666360"
              value={idadeAparenteEnv3}
              onChangeText={(t) => setIdadeAparenteEnv3(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cutisEnv3}
              onChangeText={(t) => setCutisEnv3(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Ocupação Atual"
              placeholderTextColor="#666360"
              value={ocupaçãoAtualEnv3}
              onChangeText={(t) => setOcupaçãoAtualEnv3(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Orgão Expedidor"
              placeholderTextColor="#666360"
              value={orgãoExpedidorEnv3}
              onChangeText={(t) => setOrgãoEpedidorEnv3(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="UF Nascimento"
              placeholderTextColor="#666360"
              value={ufEnvolvidoEnv3}
              onChangeText={(t) => setUfEnvolvidoEnv3(t)}
            />
            ...
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) =>
                setTipoDeEnvolvimentoEnv3(itemValue)
              }
            >
              <Picker.Item
                label="Tipo de Envolvimento"
          ...
          <View style={styles.viewEstado}>
            <InputMenor
              ...
              maxLength={8}
              placeholderTextColor="#666360"
              onEndEditing={() => buscarCepenv3(cepEnv3)}
              keyboardType="number-pad"
              value={cepEnv3}
              onChangeText={(t) => setCepEnv3(t)}
            />
            <Picker
              mode="dropdown"
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cidadeEnv3}
              onChangeText={(t) => setCidadeEnv3(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Bairro"
              placeholderTextColor="#666360"
              value={bairroEnv3}
              onChangeText={(t) => setBairroEnv3(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            <InputMenor
              ...
              placeholder="Logradouro"
              placeholderTextColor="#666360"
              value={logradouroEnv3}
              onChangeText={(t) => setLogradouroEnv3(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Número"
              keyboardType="number-pad"
              placeholderTextColor="#666360"
              value={numeroCasaEnv3}
              onChangeText={(t) => setNumeroCasaEnv3(t)}
            />
          </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <InputsInteiro
              ...
              placeholder="Complemento"
              placeholderTextColor="#666360"
              value={complementoEnv3}
              onChangeText={(t) => setComplementoEnv3(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputsInteiro
              ...
              placeholder="País"
              placeholderTextColor="#666360"
              value={paisMoradiaEnv3}
              onChangeText={(t) => setpaisMoradiaEnv3(t)}
            />
          </View>
          ...
          >
            ...
            <Switch
              ...
              trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
              value={switchEnv4}
              onValueChange={(t) => setSwitchEnv4(t)}
            />
          </View>
        </View>
      )}
        ...
        <View>
          ...
          <View style={{ marginLeft: 30, marginTop: 15 }}>
            <InputsInteiro
              ...
              placeholderTextColor="#666360"
              keyboardType="number-pad"
              value={identidadeEnv4}
              onChangeText={(t) => setIdentidadeEnv4(t)}
            />
            <InputsInteiro
              source={require("../../../assets/rgicon.png")}
              placeholder="CPF"
              ...
              keyboardType="number-pad"
              value={cpfEnv4}
              onChangeText={(t) => mascaraCpfEnv4(t)}
            />
            <InputsInteiro
              source={require("../../../assets/phone.png")}
              placeholder="Telefone"
              ...
              keyboardType="number-pad"
              value={telefoneEnv4}
              onChangeText={(t) => mascaraTelefoneEnv4(t)}
            />
          </View>
          ...
          <View style={styles.viewNascimento}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              keyboardType="number-pad"
              value={nascimentoEnv4}
              onChangeText={(t) => mascaraNascimentoEnv4(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Nacionalidade"
              placeholderTextColor="#666360"
              value={nacionalidadeEnv4}
              onChangeText={(t) => setNacionalidadeEnv4(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Naturalidade"
              placeholderTextColor="#666360"
              value={naturalidadeEnv4}
              onChangeText={(t) => setNaturalidadeEnv4(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Idade Aparente"
              placeholderTextColor="#666360"
              value={idadeAparenteEnv4}
              onChangeText={(t) => setIdadeAparenteEnv4(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cutisEnv4}
              onChangeText={(t) => setCutisEnv4(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Ocupação Atual"
              placeholderTextColor="#666360"
              value={ocupaçãoAtualEnv4}
              onChangeText={(t) => setOcupaçãoAtualEnv4(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="Orgão Expedidor"
              placeholderTextColor="#666360"
              value={orgãoExpedidorEnv4}
              onChangeText={(t) => setOrgãoEpedidorEnv4(t)}
            />
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholder="UF Nascimento"
              placeholderTextColor="#666360"
              value={ufEnvolvidoEnv4}
              onChangeText={(t) => setUfEnvolvidoEnv4(t)}
            />
            ...
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) =>
                setTipoDeEnvolvimentoEnv4(itemValue)
              }
            >
              <Picker.Item
                label="Tipo de Envolvimento"
          ...
          <View style={styles.viewEstado}>
            <InputMenor
              ...
              maxLength={8}
              placeholderTextColor="#666360"
              onEndEditing={() => buscarCepenv4(cepEnv4)}
              keyboardType="number-pad"
              value={cepEnv4}
              onChangeText={(t) => setCepEnv4(t)}
            />
            <Picker
              mode="dropdown"
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cidadeEnv4}
              onChangeText={(t) => setCidadeEnv4(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Bairro"
              placeholderTextColor="#666360"
              value={bairroEnv4}
              onChangeText={(t) => setBairroEnv4(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            <InputMenor
              ...
              placeholder="Logradouro"
              placeholderTextColor="#666360"
              value={logradouroEnv4}
              onChangeText={(t) => setLogradouroEnv4(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Número"
              keyboardType="number-pad"
              placeholderTextColor="#666360"
              value={numeroCasaEnv4}
              onChangeText={(t) => setNumeroCasaEnv4(t)}
            />
          </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <InputsInteiro
              ...
              placeholder="Complemento"
              placeholderTextColor="#666360"
              value={complementoEnv4}
              onChangeText={(t) => setComplementoEnv4(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputsInteiro
              ...
              placeholder="País"
              placeholderTextColor="#666360"
              value={paisMoradiaEnv4}
              onChangeText={(t) => setpaisMoradiaEnv4(t)}
            />
          </View>
        </View>
      )}
      ...
      >
        ...
        <Switch
          thumbColor="#FF9000"
          trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
          value={switchAgenteParticipante1}
          onValueChange={(t) => setSwitchAgenteParticipante1(t)}
        />
      </View>
        ...
        <View>
          <View style={{ marginLeft: 30, marginTop: 15 }}>
            <InputsInteiro
              ...
              value={searchAgente1}
              onChangeText={(t) => setSearchAgente1(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            ...
            <InputMenorAinda
              ...
              placeholderTextColor="#666360"
              value={siapeAgente1}
              onChangeText={(t) => setSiapeAgente1(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cargoAgente1}
              onChangeText={(t) => setCargoAgente1(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Matrícula"
              placeholderTextColor="#666360"
              value={matriculaAgente1}
              onChangeText={(t) => setMatriculaAgente1(t)}
            />
          </View>
          ...
          <Picker
            ...
            onValueChange={(itemValue, itemIndex) =>
              setTipoEnvolvimentoAgente1(itemValue)
            }
          >
            <Picker.Item label="Agente Integrante" value="Agente Integrante" />
            <Picker.Item
              label="Responsável pela Apreensão/Prisão/Condução"
              value="Responsável pela Apreensão/Prisão/Condução"
            />
          </Picker>
          ...
          >
            ...
            <Switch
              thumbColor="#FF9000"
              trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
              value={switchAgenteParticipante2}
              onValueChange={(t) => setSwitchAgenteParticipante2(t)}
            />
          </View>
        </View>
      )}
        ...
        <View>
          <View style={{ marginLeft: 30, marginTop: 15 }}>
            <InputsInteiro
              ...
              placeholder="Pesquisar Nome"
              placeholderTextColor="#666360"
              onEndEditing={handleClickSearchAgente2}
              value={searchAgente2}
              onChangeText={(t) => setSearchAgente2(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            ...
            <InputMenorAinda
              ...
              placeholderTextColor="#666360"
              value={siapeAgente2}
              onChangeText={(t) => setSiapeAgente2(t)}
            />
          </View>
          ...
          <View style={styles.viewLogradoro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={cargoAgente2}
              onChangeText={(t) => setCargoAgente2(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Matrícula"
              placeholderTextColor="#666360"
              value={matriculaAgente2}
              onChangeText={(t) => setMatriculaAgente2(t)}
            />
          </View>
          ...
          <Picker
            ...
            onValueChange={(itemValue, itemIndex) =>
              setTipoEnvolvimentoAgente2(itemValue)
            }
          >
            <Picker.Item label="Agente Integrante" value="Agente Integrante" />
            <Picker.Item
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          source={require("../../../assets/map-pin.png")}
          placeholder="Alvo do Evento"
          placeholderTextColor="#666360"
          value={alvoDoEvento}
          onChangeText={(t) => setAlvoDoEvento(t)}
        />
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          ...
          placeholderTextColor="#666360"
          value={dataDoFato}
          onChangeText={(t) => mascaraDataFato(t)}
        />
        <InputMenorAinda
          source={require("../../../assets/calendar.png")}
          placeholder="Hora do Fato"
          keyboardType="number-pad"
          placeholderTextColor="#666360"
          value={horarioDoFato}
          onChangeText={(t) => mascaraHoraDoFato(t)}
        />
      </View>
      ...
      <View style={styles.viewCidadeBairro}>
        <InputMenor
          ...
          placeholderTextColor="#666360"
          value={dataFinal}
          onChangeText={(t) => mascaraDataFinal(t)}
        />
        <InputMenorAinda
          source={require("../../../assets/calendar.png")}
          ...
          placeholderTextColor="#666360"
          value={horarioFinal}
          onChangeText={(t) => mascaraHoraFinal(t)}
        />
      </View>

      <TextInput
        style={styles.inputObjRec}
        color="#fff"
        placeholder="                             Objetos Recolhidos"
        placeholderTextColor="#666360"
        multiline={true}
        textAlignVertical="top"
        value={objetosRecolhidos}
        onChangeText={(t) => setObjetosRecolhidos(t)}
      />
      ...
      <View style={styles.viewTipoRo}>
        {permissaoBo && (
          ...
          >
            <Picker.Item
              label="*Escolha Tipo Ocorrencia"
              value="*Escolha Tipo Ocorrencia"
            />
      ...
      >
        {Object.keys(tipoOcorrencia).map((key) => {
          return (
            <Picker.Item label={tipoOcorrencia[key]} value={key} key={key} />
        ...
        <View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchMarcaDagua}
                onValueChange={(t) => setSwitchMarcaDagua(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row", marginRight: 5 }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchMicroImpressoes}
                onValueChange={(t) => setSwitchMicroImpressoes(t)}
              />
            </View>
          </View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchRegistroCoincidente}
                onValueChange={(t) => setSwitchRegistroCoincidente(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchImagemLatente}
                onValueChange={(t) => setSwitchImagemLatente(t)}
              />
            </View>
          </View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <View style={{ marginRight: 10, marginTop: 3 }}>
                <Text style={{ color: "#fff", fontSize: 12 }}>
                  IMPRESSÃO ALTO RELEVO
                </Text>
              </View>
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchImpressaoRelevo}
                onValueChange={(t) => setSwitchImpressaoRelevo(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchNumeraçaoNota}
                onValueChange={(t) => setSwitchNumeraçaoNot(t)}
              />
            </View>
          </View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchFibrasColoridas}
                onValueChange={(t) => setSwitchFibrasColoridas(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchMarcaTatil}
                onValueChange={(t) => setSwitchMarcaTatil(t)}
              />
            </View>
          </View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchFioDeSegurança}
                onValueChange={(t) => setSwitchFioDeSegurança(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchFundosEspeciais}
                onValueChange={(t) => setSwitchFundosEspeciais(t)}
              />
            </View>
          </View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchFibrasLuzVioleta}
                onValueChange={(t) => setSwitchFibrasLuzVioleta(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchFaixaHoografica}
                onValueChange={(t) => setSwitchFaixaHoografica(t)}
              />
            </View>
          </View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchTipoDoPapel}
                onValueChange={(t) => setSwitchTipoDoPapel(t)}
              />
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Switch
                thumbColor="#FF9000"
                trackColor={{ true: "#FF9000", false: "#2E2E2E" }}
                value={switchJanelaTransparente}
                onValueChange={(t) => setSwitchJaneaTransparete(t)}
              />
            </View>
          </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <InputsInteiro
              ...
              onChangeText={(t) => setOutrasCaracteristicas(t)}
            />
          </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <InputsInteiro
              source={require("../../../assets/map-pin.png")}
              placeholder="Origem da cédula"
              placeholderTextColor="#666360"
              value={origemCedula}
              onChangeText={(t) => setOrigemCedula(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              ...
              placeholderTextColor="#666360"
              value={estadoAnimo}
              onChangeText={(t) => setEstadoAnimo(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Tentou evadir"
              placeholderTextColor="#666360"
              value={tentouEvadir}
              onChangeText={(t) => setTentouEvadir(t)}
            />
          </View>
          ...
          <View style={styles.viewCidadeBairro}>
            <InputMenor
              source={require("../../../assets/map-pin.png")}
              placeholder="Possuía outras cédulas válidas"
              placeholderTextColor="#666360"
              value={possuiaOutrasCedulas}
              onChangeText={(t) => setPossuiaOutrascCeduas(t)}
            />
            <InputMenorAinda
              source={require("../../../assets/map-pin.png")}
              placeholder="Pagou após o fato"
              placeholderTextColor="#666360"
              value={pagouApos}
              onChangeText={(t) => setPagouApos(t)}
            />
          </View>
        </View>
      )}
      ...
      <TextInput
        style={styles.inputHist}
        color="#fff"
        placeholder="                         *Histórico da ocorrência"
        placeholderTextColor="#666360"
        multiline={true}
        textAlignVertical="top"
        value={historico}
        onChangeText={(t) => setHistorico(t)}
      />
      <Text
        style={{ color: "#fff", fontSize: 12, marginLeft: 30, marginTop: 15 }}
      >
        * Campos Obrigatórios
      </Text>
