...
export default () => {
  ...
  const [matriculaAgenteResponsavel, setMatriculaAgenteResponsavel] =
    useState();
  ...
  const [horaGearacao, setHoraGeracao] = useState(
    ...
    try {
      firebase
        ...
        .then((snapshot) => {
          ...
          const tipoEnvolvimentoAgente1 =
            snapshot.val().tipoEnvolvimentoAgente1;
          ...
          const tipoEnvolvimentoAgente2 =
            snapshot.val().tipoEnvolvimentoAgente2;
    ...
    try {
      ...
      if (permission.granted) {
        ...
        alert(
          "PDF: " +
            uri.split(
              "file:///data/user/0/host.exp.exponent/cache/ExperienceData/%2540h-michel%252FInfoseg/Print/",
            ) +
            " \nbaixado com sucesso!",
        );
      }
  ...
  useEffect(() => {
    if (
      tipoEnvolvimentoAgente1 === "Responsável pela Apreensão/Prisão/Condução"
    ) {
    ...
    if (
      tipoEnvolvimentoAgente2 === "Responsável pela Apreensão/Prisão/Condução"
    ) {
...
`;
  ...
  return (
    <Container>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={{}}>
                ...
                <View style={{ marginTop: 16 }}>
                  <TextLabel>
                    RG:<TextLabelText>{identidade}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    CPF:<TextLabelText>{cpf}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Telefone:<TextLabelText>{telefone}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Nascimento:<TextLabelText>{nascimento}</TextLabelText>
                  </TextLabel>
                </View>
              </View>
            </View>
      ...
      <View style={{ marginLeft: 30 }}>
        <TextLabelcamposmae>
          Mãe:<TextCamposmae>{mae}</TextCamposmae>
        </TextLabelcamposmae>
        <TextLabelcamposmae>
          Pai:<TextCamposmae>{pai}</TextCamposmae>
        </TextLabelcamposmae>

        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Nascimento:<TextCamposmae>{nascimento}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Genero:<TextCamposmae>{genero}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Nacionalidade:<TextCamposmae>{nacionalidade}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Naturalidade:<TextCamposmae>{naturalidade}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Idade Aparente:<TextCamposmae>{idadeAparente}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Estado Civil:<TextCamposmae>{estadoCivil}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Cútis:<TextCamposmae>{cutis}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Ocupação:<TextCamposmae>{ocupaçãoAtual}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Orgão Epedidor:<TextCamposmae>{orgãoExpedidor}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Escolaridade:<TextCamposmae>{grauEscoar}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              UF.Nascimento:<TextCamposmae>{ufEnvolvido}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Envolvimento:<TextCamposmae>{tipoDeEnvolvimento}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
      </View>
      ...
      <View style={{ marginLeft: 30, marginTop: 35 }}>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              CEP:<TextCamposmae>{cep}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              UF:<TextCamposmae>{ufEnvolvido}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Cidade:<TextCamposmae>{cidade}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Bairro:<TextCamposmae>{bairro}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        <TextLabelcamposmae>
          Logradouro:<TextCamposmae>{logradouro}</TextCamposmae>
        </TextLabelcamposmae>

        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Número:<TextCamposmae>{numeroCasa}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              País:<TextCamposmae>{paisMoradia}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>

        <TextLabelcamposmae>
          Complemento:<TextCamposmae>{complemento}</TextCamposmae>
        </TextLabelcamposmae>
      </View>
      ...
      {env2 && (
        <>
          <ViewQualificaçao>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ marginLeft: 30 }}>
                ...
                <View style={{ marginTop: 16 }}>
                  <TextLabel>
                    RG:<TextLabelText>{identidadeEnv2}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    CPF:<TextLabelText>{cpfEnv2}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Telefone:<TextLabelText>{telefoneEnv2}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Nascimento:<TextLabelText>{nascimentoEnv2}</TextLabelText>
                  </TextLabel>
                </View>
              </View>
            </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <TextLabelcamposmae>
              Mãe:<TextCamposmae>{maeEnv2}</TextCamposmae>
            </TextLabelcamposmae>
            <TextLabelcamposmae>
              Pai:<TextCamposmae>{paiEnv2}</TextCamposmae>
            </TextLabelcamposmae>

            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Nascimento:<TextCamposmae>{nascimentoEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Genero:<TextCamposmae>{generoEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Nacionalidade:
                  <TextCamposmae>{nacionalidadeEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Naturalidade:<TextCamposmae>{naturalidadeEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Idade Aparente:
                  <TextCamposmae>{idadeAparenteEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Estado Civil:<TextCamposmae>{estadoCivilEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Cútis:<TextCamposmae>{cutisEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Ocupação:<TextCamposmae>{ocupaçãoAtualEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Orgão Epedidor:
                  <TextCamposmae>{orgãoExpedidorEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Escolaridade:<TextCamposmae>{grauEscoarEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  UF.Nascimento:<TextCamposmae>{ufEnvolvidoEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
              ...
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Envolvimento:
                  <TextCamposmae>{tipoDeEnvolvimentoEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
          </View>
          ...
          <View style={{ marginLeft: 30, marginTop: 35 }}>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  CEP:<TextCamposmae>{cepEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  UF:<TextCamposmae>{ufEnvolvidoEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Cidade:<TextCamposmae>{cidadeEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Bairro:<TextCamposmae>{bairroEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            <TextLabelcamposmae>
              Logradouro:<TextCamposmae>{logradouroEnv2}</TextCamposmae>
            </TextLabelcamposmae>

            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Número:<TextCamposmae>{numeroCasaEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  País:<TextCamposmae>{paisMoradiaEnv2}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>

            <TextLabelcamposmae>
              Complemento:<TextCamposmae>{complementoEnv2}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </>
      )}
      ...
      {env3 && (
        <>
          <ViewQualificaçao>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ marginLeft: 30 }}>
                ...
                <View style={{ marginTop: 16 }}>
                  <TextLabel>
                    RG:<TextLabelText>{identidadeEnv3}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    CPF:<TextLabelText>{cpfEnv3}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Telefone:<TextLabelText>{telefoneEnv3}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Nascimento:<TextLabelText>{nascimentoEnv3}</TextLabelText>
                  </TextLabel>
                </View>
              </View>
            </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <TextLabelcamposmae>
              Mãe:<TextCamposmae>{maeEnv3}</TextCamposmae>
            </TextLabelcamposmae>
            <TextLabelcamposmae>
              Pai:<TextCamposmae>{paiEnv3}</TextCamposmae>
            </TextLabelcamposmae>

            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Nascimento:<TextCamposmae>{nascimentoEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Genero:<TextCamposmae>{generoEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Nacionalidade:
                  <TextCamposmae>{nacionalidadeEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Naturalidade:<TextCamposmae>{naturalidadeEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Idade Aparente:
                  <TextCamposmae>{idadeAparenteEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Estado Civil:<TextCamposmae>{estadoCivilEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Cútis:<TextCamposmae>{cutisEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Ocupação:<TextCamposmae>{ocupaçãoAtualEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Orgão Epedidor:
                  <TextCamposmae>{orgãoExpedidorEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Escolaridade:<TextCamposmae>{grauEscoarEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  UF.Nascimento:<TextCamposmae>{ufEnvolvidoEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
              ...
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Envolvimento:
                  <TextCamposmae>{tipoDeEnvolvimentoEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
          </View>
          ...
          <View style={{ marginLeft: 30, marginTop: 35 }}>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  CEP:<TextCamposmae>{cepEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  UF:<TextCamposmae>{ufEnvolvidoEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Cidade:<TextCamposmae>{cidadeEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Bairro:<TextCamposmae>{bairroEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            <TextLabelcamposmae>
              Logradouro:<TextCamposmae>{logradouroEnv3}</TextCamposmae>
            </TextLabelcamposmae>

            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Número:<TextCamposmae>{numeroCasaEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  País:<TextCamposmae>{paisMoradiaEnv3}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>

            <TextLabelcamposmae>
              Complemento:<TextCamposmae>{complementoEnv3}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </>
      )}
      ...
      {env4 && (
        <>
          <ViewQualificaçao>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ marginLeft: 30 }}>
                ...
                <View style={{ marginTop: 16 }}>
                  <TextLabel>
                    RG:<TextLabelText>{identidadeEnv4}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    CPF:<TextLabelText>{cpfEnv4}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Telefone:<TextLabelText>{telefoneEnv4}</TextLabelText>
                  </TextLabel>
                  <TextLabel>
                    Nascimento:<TextLabelText>{nascimentoEnv4}</TextLabelText>
                  </TextLabel>
                </View>
              </View>
            </View>
          ...
          <View style={{ marginLeft: 30 }}>
            <TextLabelcamposmae>
              Mãe:<TextCamposmae>{maeEnv4}</TextCamposmae>
            </TextLabelcamposmae>
            <TextLabelcamposmae>
              Pai:<TextCamposmae>{paiEnv4}</TextCamposmae>
            </TextLabelcamposmae>

            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Nascimento:<TextCamposmae>{nascimentoEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Genero:<TextCamposmae>{generoEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Nacionalidade:
                  <TextCamposmae>{nacionalidadeEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Naturalidade:<TextCamposmae>{naturalidadeEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Idade Aparente:
                  <TextCamposmae>{idadeAparenteEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Estado Civil:<TextCamposmae>{estadoCivilEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Cútis:<TextCamposmae>{cutisEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Ocupação:<TextCamposmae>{ocupaçãoAtualEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Orgão Epedidor:
                  <TextCamposmae>{orgãoExpedidorEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Escolaridade:<TextCamposmae>{grauEscoarEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  UF.Nascimento:<TextCamposmae>{ufEnvolvidoEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
              ...
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Envolvimento:
                  <TextCamposmae>{tipoDeEnvolvimentoEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
          </View>
          ...
          <View style={{ marginLeft: 30, marginTop: 35 }}>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  CEP:<TextCamposmae>{cepEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  UF:<TextCamposmae>{ufEnvolvidoEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Cidade:<TextCamposmae>{cidadeEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Bairro:<TextCamposmae>{bairroEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            <TextLabelcamposmae>
              Logradouro:<TextCamposmae>{logradouroEnv4}</TextCamposmae>
            </TextLabelcamposmae>

            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Número:<TextCamposmae>{numeroCasaEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  País:<TextCamposmae>{paisMoradiaEnv4}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>

            <TextLabelcamposmae>
              Complemento:<TextCamposmae>{complementoEnv4}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </>
      )}
      ...
      {notaFalsa && (
        <>
          <View style={{ marginLeft: 30, marginTop: 35 }}>
            <TextDetallhesOcorr>
              CARACTERÍSTICAS QUE EVIDENCIAM A POSSIBILIDADE DE FALSIFICAÇÃO
            </TextDetallhesOcorr>
          </View>
          ...
          <View style={{ marginTop: 15, marginLeft: 30 }}>
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Marca D'água:<TextCamposmae>{marcaDagua}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
              ...
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Microimpressões:
                  <TextCamposmae>{microImpressoes}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  ...
                  <TextCamposmae>{registroCoincidente}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Imagem Latente:<TextCamposmae>{imagemLatente}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  ...
                  <TextCamposmae>{impressaoRelevo}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Numeração:<TextCamposmae>{numeraçaoNota}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Fibras Coloridas:
                  <TextCamposmae>{fibrasColoridas}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Marca Tátil:<TextCamposmae>{marcaTatil}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Fio de Segurança:
                  <TextCamposmae>{fioDeSegurança}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
              ...
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Fundos Especiais:
                  <TextCamposmae>{fundosEspeciais}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Fibras Sensíveis:
                  <TextCamposmae>{fibrasLuzVioleta}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
              ...
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Faixa Holográfica:
                  <TextCamposmae>{faixaHoografica}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Janela Transarente:
                  <TextCamposmae>{janelaTransparente}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View>
              <TextLabelcamposmae>
                Tipo e/ou Tamanho do Papel:
                <TextCamposmae>{tipoPapel}</TextCamposmae>
              </TextLabelcamposmae>
              <TextLabelcamposmae>
                Moeda:<TextCamposmae>{moeda}</TextCamposmae>
              </TextLabelcamposmae>
              <TextLabelcamposmae>
                Outros:<TextCamposmae>{outrasCaracteristicas}</TextCamposmae>
              </TextLabelcamposmae>
            </View>

            <View style={{ marginTop: 35 }}>
              <TextDetallhesOcorr>
                Informações Prestadas pelo Envolvido
              </TextDetallhesOcorr>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Origem da Cédula:<TextCamposmae>{origemCedula}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Estado de Ânimo:<TextCamposmae>{estadoAnimo}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Tentou Evadir:<TextCamposmae>{tentouEvadir}</TextCamposmae>
                </TextLabelcamposmae>
              </View>

              <View style={{ flex: 1 }}>
                <TextLabelcamposmae>
                  Pagou Após:<TextCamposmae>{pagouApos}</TextCamposmae>
                </TextLabelcamposmae>
              </View>
            </View>
            <TextLabelcamposmae>
              Possuía Outras édulas Válidas:
              <TextCamposmae>{possuiaOutrasCedulas}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </>
      )}
      ...
      <View style={{ marginTop: 15, marginLeft: 30 }}>
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Data Relatório:<TextCamposmae>{data}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Hora Relatório:<TextCamposmae>{hora}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Data do Fato:<TextCamposmae>{dataDoFato}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Hora do Fato:<TextCamposmae>{horarioDoFato}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Data Final:<TextCamposmae>{dataFinal}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Hora Final:<TextCamposmae>{horarioFinal}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Tentado/Consumado:
              <TextCamposmae>{tentadoConsumado}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Alvo do Evento:<TextCamposmae>{alvoDoEvento}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              {tipoRo}:<TextCamposmae>{tipoOcorrencia1}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Local:<TextCamposmae>{local}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Relator:<TextCamposmae>{nomeAgenteRelator}</TextCamposmae>
            </TextLabelcamposmae>
          </View>

          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              Agente Integrante:<TextCamposmae>{nomeAgente1}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <TextLabelcamposmae>
              ...
              <TextCamposmae>{nomeAgenteResponsavel}</TextCamposmae>
            </TextLabelcamposmae>
          </View>
        </View>
        ...
        <View>
          <TextLabelcamposmae>
            Objetos Recolhidos:
            <TextCamposmae>{objetosRecolhidos}</TextCamposmae>
          </TextLabelcamposmae>
          <TextLabelcamposmae>
            Histórico:<TextCamposmae>{historico}</TextCamposmae>
          </TextLabelcamposmae>
        </View>
      </View>
      ...
      {freedown && (
        <>
          ...
          >
            <BtnCadastrarOcorrencia
              disabled={loading}
              onPress={() => createAndSavePDF(htmlContent1)}
            >
