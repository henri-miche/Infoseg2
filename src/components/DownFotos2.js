      ...
      {avatar2 && (
        <>
          <View style={styles.row}>
            ...
            <View style={{ marginTop: 15, marginLeft: 14 }}>
              ...
              <View style={styles.viewRoLocal}>
                <TextLabelP numberOfLines={2} ellipsizeMode="tail">
                  {tipoRo}:<TextPool>{tipoOcorrencia1}</TextPool>
                </TextLabelP>
                <TextLabel>
                  Local:<TextPool>{local}</TextPool>{" "}
                </TextLabel>
              </View>
              <TextLabelP>
                ASO:<TextPool>{nomeAgenteRelator}</TextPool>
              </TextLabelP>
            </View>
          </View>
          ...
          <View style={styles.viewCalendario}>
            <Image
              source={require("../../assets/Calendário.png")}
            ...
            >
              <Image
                source={require("../../assets/Horário.png")}
                styles={{ width: 14, height: 14 }}
              />
          ...
          <ViewHist>
            <TextLabelP numberOfLines={3} ellipsizeMode="tail">
              Histórico:<Texthist>{historico}</Texthist>
            </TextLabelP>
          </ViewHist>
          <BtnOcorrenciaFull onPress={handleClickVerCompleta}>
            <Text style={styles.textBtnOcorr}>Ver Ocorrência Completa</Text>
            <Image
              source={require("../../assets/setaocorrenciacompleta.png")}
            />
          </BtnOcorrenciaFull>
        </>
      )}
